...
public class Point3D implements Serializable {
    ...
    public Point3D swapXY() {
        Point3D swapped = new Point3D(this.y, this.x, this.z, this.bulge);
        swapped.id = this.id;
        swapped.description = this.description;
        swapped.filename = this.filename;
        swapped.colore = this.colore;
        swapped.layer = this.layer;
        swapped.dxfStyle = this.dxfStyle != null ? this.dxfStyle.copy() : null;
        return swapped;
    }
    ...
    public static Point3D centroidAreaWeighted(Face3D f) {
        ...
        double sumA = a1 + a2;
        if (sumA == 0) return calculateCentroid(f.p1, f.p2, f.p3, f.p4);
    ...
    public Point3D clone() {
        ...
        p.colore = this.colore;
        p.layer = this.layer;
        p.dxfStyle = this.dxfStyle != null ? this.dxfStyle.copy() : null;
        return p;
    }
}
