...
public class DxfBlock implements Serializable {
    ...
    public void setBaseZ(double baseZ) { this.baseZ = baseZ; }
    ...
    public void addLine(Line line) { if (line != null) lines.add(line); }
    public void addPolyline(Polyline polyline) { if (polyline != null) polylines.add(polyline); }
    public void addPolyline2D(Polyline_2D polyline) { if (polyline != null) polylines2D.add(polyline); }
    public void addPoint(Point3D point) { if (point != null) points.add(point); }
    public void addPointDrill(Point3D_Drill pointDrill) { if (pointDrill != null) point3DDrills.add(pointDrill); }
    public void addCircle(Circle circle) { if (circle != null) circles.add(circle); }
    public void addArc(Arc arc) { if (arc != null) arcs.add(arc); }
    public void addEllipse(Ellipse ellipse) { if (ellipse != null) ellipses.add(ellipse); }
    public void addSpline(Spline spline) { if (spline != null) splines.add(spline); }
    public void addHatch(Hatch hatch) { if (hatch != null) hatches.add(hatch); }
    public void addDimension(Dimension dimension) { if (dimension != null) dimensions.add(dimension); }
    public void addSolid(Solid solid) { if (solid != null) solids.add(solid); }
    public void addTrace(Trace trace) { if (trace != null) traces.add(trace); }
    public void addLeader(Leader leader) { if (leader != null) leaders.add(leader); }
    public void addXLine(XLine xLine) { if (xLine != null) xLines.add(xLine); }
    public void addRay(Ray ray) { if (ray != null) rays.add(ray); }
    public void addText(DxfText text) { if (text != null) texts.add(text); }
    public void addFace(Face3D face) { if (face != null) faces.add(face); }
    public void addInsert(DxfInsert insert) { if (insert != null) inserts.add(insert); }
