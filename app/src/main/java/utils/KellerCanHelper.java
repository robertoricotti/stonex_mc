...
public class KellerCanHelper {

    public static volatile KellerCanHelper INSTANCE = null;
    ...
    public static KellerCanHelper getInstance() {
        if (INSTANCE == null) {
            synchronized (KellerCanHelper.class) {
                if (INSTANCE == null) {
                    INSTANCE = new KellerCanHelper();
                }
            }
        }
        return INSTANCE;
     ...
     */
    public synchronized void start(CPCanHelper.Action action) {
        try {
            switch (device) {
                case "SRT8PROS":
                case "SRT7PROS":
                case "APOLLO2_10":
                    ...
                    try {
                        ...
                        mProxy.setCANBaudrate(Protocol.CAN_BAUD_250K, Protocol.CAN_BAUD_250K);
                        ...
                        if (mProxy != null && mProxy.isConnected()) {
                            mProxy.setOnVoltageChanged(new VoltageChangedListener() {
                                ...
                                public void onVoltageChanged(float v) {
                                    ...
                                    Log.d("KellerVoltage",String.valueOf(v));
                                }
                            });
                        }
                ...
                case "APOLLO2_12_PLUS":
                    ...
                    try {
                        ...
                        mSocketCanProxy.setCANBaudrate(Protocol.CAN_BAUD_250K, Protocol.CAN_BAUD_2M);
                        ...
                        mSocketCanProxy_2.setCANBaudrate(Protocol.CAN_BAUD_250K, Protocol.CAN_BAUD_2M);
