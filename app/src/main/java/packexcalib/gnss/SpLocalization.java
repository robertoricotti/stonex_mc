...
public final class SpLocalization implements LocalizationModel {
    ...
    public static SpLocalization fromSpFile(File f) throws Exception {
        ...
        if (proj == null) throw new IllegalArgumentException("SP non valido: manca CoordinateSystem_ProjectParameter");
        ...
        boolean use4 = false; double Cx=0, Cy=0, Ca=0, Ck=1, Orgx=0, Orgy=0;
        if (four != null) {
        ...
        boolean useHF = false; double a0=0,a1=0,a2=0,a3=0,a4=0,a5=0;
        if (hf != null) {
            useHF = isTrue(txt(hf,"Use","0"));
            a0 = d(txt(hf,"a0","0")); a1 = d(txt(hf,"a1","0")); a2 = d(txt(hf,"a2","0"));
            a3 = d(txt(hf,"a3","0")); a4 = d(txt(hf,"a4","0")); a5 = d(txt(hf,"a5","0"));
        }

        return new SpLocalization(geoToProj, use4, Cx, Cy, CaCCW, Ck, Orgx, Orgy,
