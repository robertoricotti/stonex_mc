...
public class ProjectReportXlsxWriter {
    ...
    public File getXlsxFile() { return xlsxFile; }
    ...
    private String[] activeHeader() {
        switch (reportType) {
            case ROCKDRILL: return HEADER_ROCK;
            case JETGROUTING: return HEADER_JET;
            case SOLARFARM: return HEADER_SOLAR;
            default: return HEADER_JET;
        }
    }
    ...
    private static String shortType(ReportType t) {
        switch (t) {
            case ROCKDRILL: return "ROCK";
            case JETGROUTING: return "JET";
            case SOLARFARM: return "SOLAR";
