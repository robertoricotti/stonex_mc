...
public class IrdParser {
    ...
    private static void applyJetField(Point3D_Drill p, String key, String value) {
        ...
        switch (key) {
            // ---- DRILL 1..4 ----
            case "drlStart_1":
                p.setDrlStart_1(value);
                break;
            case "drlStop_1":
                p.setDrlStop_1(value);
                break;
            case "pr_1":
                p.setPr_1(value);
                break;
            ...
            case "drlStart_2":
                p.setDrlStart_2(value);
                break;
            case "drlStop_2":
                p.setDrlStop_2(value);
                break;
            case "pr_2":
                p.setPr_2(value);
                break;
            ...
            case "drlStart_3":
                p.setDrlStart_3(value);
                break;
            case "drlStop_3":
                p.setDrlStop_3(value);
                break;
            case "pr_3":
                p.setPr_3(value);
                break;
            ...
            case "drlStart_4":
                p.setDrlStart_4(value);
                break;
            case "drlStop_4":
                p.setDrlStop_4(value);
                break;
            case "pr_4":
                p.setPr_4(value);
                break;
            ...
            // ---- JET 1..4 ----
            case "jetStart_1":
                p.setJetStart_1(value);
                break;
            case "jetStop_1":
                p.setJetStop_1(value);
                break;
            case "pr_j_1":
                p.setPr_j_1(value);
                break;
            ...
            case "jetStart_2":
                p.setJetStart_2(value);
                break;
            case "jetStop_2":
                p.setJetStop_2(value);
                break;
            case "pr_j_2":
                p.setPr_j_2(value);
                break;
            ...
            case "jetStart_3":
                p.setJetStart_3(value);
                break;
            case "jetStop_3":
                p.setJetStop_3(value);
                break;
            case "pr_j_3":
                p.setPr_j_3(value);
                break;
            ...
            case "jetStart_4":
                p.setJetStart_4(value);
                break;
            case "jetStop_4":
                p.setJetStop_4(value);
                break;
            case "pr_j_4":
                p.setPr_j_4(value);
                break;
