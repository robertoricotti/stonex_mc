...
public class DrawDXF_Layer2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            double bucket_angle = Deg_Boom_Roll * -1;
            ...
            if (DataSaved.isWL == EXCAVATOR) {
                ...
                canvas.drawCircle((stick.get(3).x + stick.get(4).x) / 2f, (stick.get(3).y + stick.get(4).y) / 2f, getDistance(stick.get(3).x, stick.get(3).y, stick.get(4).x, stick.get(4).y) / 2f, paint);
            }
            //-----------------------------------------------------------------------------
...
//--------------------------------- DRAW LINE --------------------------------
            ...
            canvas.drawText(Utils.readAngoloLITE(String.valueOf(Deg_Boom_Roll)) + Utils.getGradiSimbol(), (bucket.get(1).x + bucket.get(2).x + bucket.get(3).x + bucket.get(4).x) / 4f, ((bucket.get(3).y + bucket.get(4).y) / 2f) - 25f, paint);
            //-----------------------------------------------------------------------------
