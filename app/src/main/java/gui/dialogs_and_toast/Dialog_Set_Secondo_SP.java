...
public class Dialog_Set_Secondo_SP {
    private static final String ASSET_SP_ROOT = "loc_data";
    String mPath;
    ...
    public Dialog_Set_Secondo_SP(Activity activity) {
    ...
    public void init() {
        ...
        String s = "";
        s = MyData.get_String("LastNation_DUE");
        ...
        String s1 = "";
        s1 = MyData.get_String("LastSP_DUE");
        if (s1 == null) {
            inUso.setText("");
        } else {
            inUso.setText(s1);
    ...
    public void onClick() {
            ...
            if (spAdapter.getSelectedItem() == -1) {
                ...
                handler1.postDelayed(() -> {
                    try {
                        ...
                        new CustomToast(activity, "CRS ERROR").show_error();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                MyData.push("LastNation_DUE", selectedFolder);
