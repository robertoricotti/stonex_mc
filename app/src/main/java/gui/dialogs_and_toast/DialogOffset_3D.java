...
public class DialogOffset_3D {
    ...
    public DialogOffset_3D(Activity activity) {
    ...
    private void step2() {
        ...
        switch (DataSaved.bucketEdge) {
            case -1:
                MyData.push("Operator_Offset", String.valueOf(TriangleService.quota3D_SX));
                MyData.push("shortcutOffset_" + DataSaved.shortcutIndex, String.valueOf(TriangleService.quota3D_SX));
                break;

            case 0:
                MyData.push("Operator_Offset", String.valueOf(TriangleService.quota3D_CT));
                MyData.push("shortcutOffset_" + DataSaved.shortcutIndex, String.valueOf(TriangleService.quota3D_CT));
                break;

            case 1:
                MyData.push("Operator_Offset", String.valueOf(TriangleService.quota3D_DX));
                MyData.push("shortcutOffset_" + DataSaved.shortcutIndex, String.valueOf(TriangleService.quota3D_DX));
                break;
        }
        ...
        dialog.cancel();
        new CustomToast(activity, "SAVED").show();
    }
    ...
    private void onClick() {
        ...
        save.setOnClickListener((View v) -> {
            if (indexMeasure == 4 || indexMeasure == 5) {
                ...
                String mioValore =value_ft.getText().toString().trim() + "'" + value_in.getText().toString().trim() + " " + value_fraction.getText().toString().trim() + "\"".toString();                Log.d("ValoreSalvato",mioValore.trim()+"\n"+Utils.writeMetriLITE(mioValore.trim()));
        ...
        zero.setOnLongClickListener((View v) -> {
            step1();
            (new Handler()).postDelayed(this::step2, 600);
            return false;
