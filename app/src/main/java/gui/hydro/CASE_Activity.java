...
import static services.CanService.CASE_Connected;
...
public class CASE_Activity extends AppCompatActivity {
    ...
    private void onClick() {
        ...
        back.setOnClickListener(view -> {
            ...
            builder.setPositiveButton(getString(R.string.yes), (dialog, which) -> {
                ...
                startActivity(new Intent(CASE_Activity.this, Hydro_Activity_Entering.class));
                finish();
            });
    ...
    public void updateUI() {
        ...
        switch (voceMenu) {
            ...
            case 8:
                ...
                testo.setText(CanService.CASE_Joystick);
