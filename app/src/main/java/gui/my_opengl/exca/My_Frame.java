...
import static packexcalib.exca.DredgeLib.correctDredgePitch;
import static packexcalib.exca.DredgeLib.correctDredgeRoll;
...
public class My_Frame {
    ...
    public static Point3DF[] puntiFrameDredge() {
        mHdt_Boom = ((NmeaListener.mch_Orientation + DataSaved.deltaGPS2) % 360 + 360) % 360;
        ...
        double larghezzaBraccio_STRETTA = (float) (Math.max(0.22, Math.min((DataSaved.Lunghezza_Braccio * 0.22f), 0.6)));
        L1 = (DataSaved.Lunghezza_Braccio + DataSaved.Altezza_Attrezzo ) * 0.2;
        L1 = Math.max(1.5, Math.min(L1, 3.5));
        L2 = L1 * 1.4;
        Bordi = L1 * 0.2;
        H_Cab = 1.3;
        ...
        W_Cingolo = L1 * 0.25;
        p0 = coordinateDY;
        p1a = Exca_Quaternion.endPoint(p0, correctDredgePitch, correctDredgeRoll, 0.3 + (-DataSaved.Lunghezza_Pitch), mHdt_Boom);
        p2a = Exca_Quaternion.endPoint(p1a, -correctDredgeRoll, correctDredgePitch, (L1 * 0.5) - DataSaved.Lunghezza_Roll, mHdt_Boom + 90);
        p3a = Exca_Quaternion.endPoint(p2a, -correctDredgePitch, -correctDredgeRoll, L2, mHdt_Boom + 180);
        p4a = Exca_Quaternion.endPoint(p3a, correctDredgeRoll, -correctDredgePitch, L1 + DataSaved.Lunghezza_Roll, mHdt_Boom - 90);
        p5a = Exca_Quaternion.endPoint(p4a, correctDredgePitch, correctDredgeRoll, L2, mHdt_Boom);
        L_Cab = DistToPoint.dist3D(p5a, p1a) - 0.1 - (larghezzaBraccio_STRETTA * 0.5);
        L_Cab = Math.max(0.8, Math.min(L_Cab, 1.5));
        p1b = Exca_Quaternion.endPoint(p1a, correctDredgePitch - 90, correctDredgeRoll, 0.2, mHdt_Boom);
        p2b = Exca_Quaternion.endPoint(p2a, correctDredgePitch - 90, correctDredgeRoll, 0.2, mHdt_Boom);
        p3b = Exca_Quaternion.endPoint(p3a, correctDredgePitch - 90, correctDredgeRoll, 0.2, mHdt_Boom);
        p4b = Exca_Quaternion.endPoint(p4a, correctDredgePitch - 90, correctDredgeRoll, 0.2, mHdt_Boom);
        p5b = Exca_Quaternion.endPoint(p5a, correctDredgePitch - 90, correctDredgeRoll, 0.2, mHdt_Boom);

        cab0_b = p5a;
        cab1_b = Exca_Quaternion.endPoint(cab0_b, -correctDredgeRoll, correctDredgePitch, L_Cab, mHdt_Boom + 90);
        cab2_b = Exca_Quaternion.endPoint(cab1_b, -correctDredgePitch, -correctDredgeRoll, L_Cab * 1.2, mHdt_Boom + 180);
        cab3_b = Exca_Quaternion.endPoint(cab2_b, correctDredgeRoll, -correctDredgePitch, L_Cab, mHdt_Boom - 90);

        cab0_a = Exca_Quaternion.endPoint(cab0_b, correctDredgePitch + 95, correctDredgeRoll, H_Cab, mHdt_Boom);
        cab1_a = Exca_Quaternion.endPoint(cab1_b, correctDredgePitch + 95, correctDredgeRoll, H_Cab, mHdt_Boom);
        cab2_a = Exca_Quaternion.endPoint(cab2_b, correctDredgePitch + 90, correctDredgeRoll, H_Cab, mHdt_Boom);
        cab3_a = Exca_Quaternion.endPoint(cab3_b, correctDredgePitch + 90, correctDredgeRoll, H_Cab, mHdt_Boom);

        minip0 = Exca_Quaternion.endPoint(p0, Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, mHdt_Boom - 90);
        minip1 = Exca_Quaternion.endPoint(p0, -Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, mHdt_Boom + 90);
        minip2 = Exca_Quaternion.endPoint(minip1, correctDredgePitch, correctDredgeRoll, DataSaved.Lunghezza_Pitch, mHdt_Boom + 180);
        minip3 = Exca_Quaternion.endPoint(minip0, correctDredgePitch, correctDredgeRoll, DataSaved.Lunghezza_Pitch, mHdt_Boom + 180);

        minipB0 = Exca_Quaternion.endPoint(minip0, correctDredgePitch - 90, correctDredgeRoll, 0.05, mHdt_Boom);
        minipB1 = Exca_Quaternion.endPoint(minip1, correctDredgePitch - 90, correctDredgeRoll, 0.05, mHdt_Boom);
        minipB2 = Exca_Quaternion.endPoint(minip2, correctDredgePitch - 90, correctDredgeRoll, 0.1, mHdt_Boom);
        minipB3 = Exca_Quaternion.endPoint(minip3, correctDredgePitch - 90, correctDredgeRoll, 0.1, mHdt_Boom);

        zavm0 = Exca_Quaternion.endPoint(p4a, correctDredgePitch + 90, correctDredgeRoll, 0.5, mHdt_Boom);
        zavm1 = Exca_Quaternion.endPoint(cab3_b, correctDredgePitch + 90, correctDredgeRoll, 0.5, mHdt_Boom);
        zavm2 = Exca_Quaternion.endPoint(zavm1, -correctDredgeRoll, correctDredgePitch, DistToPoint.dist3D(p3a, p4a), mHdt_Boom + 90);
        finezav = Exca_Quaternion.endPoint(zavm2, correctDredgePitch - 90, correctDredgeRoll, 0.5, mHdt_Boom);
        zavm3 = Exca_Quaternion.endPoint(p3a, correctDredgePitch + 90, correctDredgeRoll, 0.5, mHdt_Boom);
        Point3D punto_0 = new Point3D(zavm0[0], zavm0[1], zavm0[2]);
        Point3D punto_1 = new Point3D(zavm2[0], zavm2[1], zavm2[2]);
        ...
        zavh0 = Exca_Quaternion.endPoint(new double[]{puntomedio0.getX(), puntomedio0.getY(), puntomedio0.getZ()}, correctDredgePitch + 90, correctDredgeRoll, 0.15, mHdt_Boom);
        zavh1 = Exca_Quaternion.endPoint(new double[]{puntomedio2.getX(), puntomedio2.getY(), puntomedio2.getZ()}, correctDredgePitch + 90, correctDredgeRoll, 0.15, mHdt_Boom);
        zavh2 = Exca_Quaternion.endPoint(new double[]{puntmedio1.getX(), puntmedio1.getY(), puntmedio1.getZ()}, correctDredgePitch + 90, correctDredgeRoll, 0.15, mHdt_Boom);
        zavh3 = Exca_Quaternion.endPoint(new double[]{puntmeodio3.getX(), puntmeodio3.getY(), puntmeodio3.getZ()}, correctDredgePitch + 90, correctDredgeRoll, 0.15, mHdt_Boom);

        Point3D pmRalla1 = new Point3D(p2b[0], p2b[1], p2b[2]);
        Point3D pmRalla2 = new Point3D(p4b[0], p4b[1], p4b[2]);
        Point3D pmRalla = pmRalla1.interpolate(pmRalla2, 1.0 / 2.0);
        rallaalta = new double[]{pmRalla.getX(), pmRalla.getY(), pmRalla.getZ()};
        rallabassa = Exca_Quaternion.endPoint(rallaalta, correctDredgePitch - 90, correctDredgeRoll, H_Ralla, mHdt_Boom);

        p2_c = Exca_Quaternion.endPoint(p2b, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.95, mHdt_Boom);
        p3_c = Exca_Quaternion.endPoint(p3b, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.95, mHdt_Boom);
        p4_c = Exca_Quaternion.endPoint(p4b, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.95, mHdt_Boom);
        p5_c = Exca_Quaternion.endPoint(p5b, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.95, mHdt_Boom);

        p2_alto = Exca_Quaternion.endPoint(p2_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p2_basso = Exca_Quaternion.endPoint(p2_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p3_alto = Exca_Quaternion.endPoint(p3_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p3_basso = Exca_Quaternion.endPoint(p3_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p4_alto = Exca_Quaternion.endPoint(p4_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p4_basso = Exca_Quaternion.endPoint(p4_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p5_alto = Exca_Quaternion.endPoint(p5_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        p5_basso = Exca_Quaternion.endPoint(p5_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);

        p2_i_c = Exca_Quaternion.endPoint(p2_c, correctDredgeRoll, -correctDredgePitch, W_Cingolo, mHdt_Boom - 90);
        p3_i_c = Exca_Quaternion.endPoint(p3_c, correctDredgeRoll, -correctDredgePitch, W_Cingolo, mHdt_Boom - 90);

        p4_i_c = Exca_Quaternion.endPoint(p4_c, -correctDredgeRoll, correctDredgePitch, W_Cingolo, mHdt_Boom + 90);
        p5_i_c = Exca_Quaternion.endPoint(p5_c, -correctDredgeRoll, correctDredgePitch, W_Cingolo, mHdt_Boom + 90);

        ai_2 = Exca_Quaternion.endPoint(p2_i_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        bi_2 = Exca_Quaternion.endPoint(p2_i_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        ai_3 = Exca_Quaternion.endPoint(p3_i_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        bi_3 = Exca_Quaternion.endPoint(p3_i_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);

        ai_4 = Exca_Quaternion.endPoint(p4_i_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        bi_4 = Exca_Quaternion.endPoint(p4_i_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        ai_5 = Exca_Quaternion.endPoint(p5_i_c, correctDredgePitch + 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        bi_5 = Exca_Quaternion.endPoint(p5_i_c, correctDredgePitch - 90, correctDredgeRoll, R_Cingolo * 0.5, mHdt_Boom);
        {
            P1_A = pTransform(p1a, DataSaved.glL_AnchorView, rs());
            P2_A = pTransform(p2a, DataSaved.glL_AnchorView, rs());
            P3_A = pTransform(p3a, DataSaved.glL_AnchorView, rs());
