...
public class My_Boom1_Boom2 {
    ...
    public static Point3DF[] puntiBoom() {
        ...
        //Boom 2 below
        p0_s = Exca_Quaternion.endPoint(coordB2, Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM - 90);
        p0_d = Exca_Quaternion.endPoint(coordB2, -Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM + 90);
        p3_s = Exca_Quaternion.endPoint(coordB1, Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM - 90);
        p3_d = Exca_Quaternion.endPoint(coordB1, -Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM + 90);

        //sx
        p1_s = Exca_Quaternion.endPoint(p0_s, correctBoom2 + 125, Deg_Boom_Roll, L1, hdt_BOOM);
        p2_s = Exca_Quaternion.endPoint(p3_s, correctBoom2 + 140, Deg_Boom_Roll, L2, hdt_BOOM);
        p4_s = Exca_Quaternion.endPoint(p3_s, correctBoom2 + 180 + 45, Deg_Boom_Roll, L3, hdt_BOOM);
        p5_s = Exca_Quaternion.endPoint(p0_s, correctBoom2 - 125, Deg_Boom_Roll, L1, hdt_BOOM);

        //dx
        p1_d = Exca_Quaternion.endPoint(p0_d, correctBoom2 + 125, Deg_Boom_Roll, L1, hdt_BOOM);
        p2_d = Exca_Quaternion.endPoint(p3_d, correctBoom2 + 140, Deg_Boom_Roll, L2, hdt_BOOM);
        p4_d = Exca_Quaternion.endPoint(p3_d, correctBoom2 + 180 + 45, Deg_Boom_Roll, L3, hdt_BOOM);
        p5_d = Exca_Quaternion.endPoint(p0_d, correctBoom2 - 125, Deg_Boom_Roll, L1, hdt_BOOM);

        ////Boom 1 below
        p6_s = Exca_Quaternion.endPoint(coordB1, Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM - 90);
        p6_d = Exca_Quaternion.endPoint(coordB1, -Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM + 90);
        p9_s = Exca_Quaternion.endPoint(coordinateDY, Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM - 90);
        p9_d = Exca_Quaternion.endPoint(coordinateDY, -Deg_Boom_Roll, 0, larghezzaBraccio_STRETTA * 0.5, hdt_BOOM + 90);

        //sx
        p7_s = Exca_Quaternion.endPoint(p6_s, correctBoom1 + 125, Deg_Boom_Roll, L4, hdt_BOOM);
        p11_s = Exca_Quaternion.endPoint(p6_s, correctBoom1 - 125, Deg_Boom_Roll, L4, hdt_BOOM);
        p8_s = Exca_Quaternion.endPoint(p9_s, correctBoom1 + 55, Deg_Boom_Roll, L4*1.4, hdt_BOOM);
        p10_s = Exca_Quaternion.endPoint(p9_s, correctBoom1 - 55, Deg_Boom_Roll, L4*1.4, hdt_BOOM);

        //dx
        p7_d = Exca_Quaternion.endPoint(p6_d, correctBoom1 + 125, Deg_Boom_Roll, L4, hdt_BOOM);
        p11_d = Exca_Quaternion.endPoint(p6_d, correctBoom1 - 125, Deg_Boom_Roll, L4, hdt_BOOM);
        p8_d = Exca_Quaternion.endPoint(p9_d, correctBoom1 + 55, Deg_Boom_Roll, L4*1.4, hdt_BOOM);
        p10_d = Exca_Quaternion.endPoint(p9_d, correctBoom1 - 55, Deg_Boom_Roll, L4*1.4, hdt_BOOM);
