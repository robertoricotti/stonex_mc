...
public class My_Lama {
    ...
    public static Point3DF[] puntiLama() {
        ...
        p4 = Exca_Quaternion.endPoint(p1, correctPitch + 90, correctRoll, DataSaved.altezzaLama, hdt_LAMA);
        p5 = Exca_Quaternion.endPoint(p0, correctPitch + 90, correctRoll, DataSaved.altezzaLama, hdt_LAMA);
        p6 = Exca_Quaternion.endPoint(p9, correctPitch + 90, correctRoll, DataSaved.altezzaLama, hdt_LAMA);
        p2 = Exca_Quaternion.endPoint(p1, correctPitch + 120, correctRoll, DataSaved.altezzaLama * 0.2, hdt_LAMA);
        p8 = Exca_Quaternion.endPoint(p9, correctPitch + 120, correctRoll, DataSaved.altezzaLama * 0.2, hdt_LAMA);
        p10 = Exca_Quaternion.endPoint(p1, correctPitch + 160, correctRoll, DataSaved.altezzaLama * 0.35, hdt_LAMA);
        p11 = Exca_Quaternion.endPoint(p4, correctPitch + 200, correctRoll, DataSaved.altezzaLama * 0.35, hdt_LAMA);
        p12 = Exca_Quaternion.endPoint(p6, correctPitch + 200, correctRoll, DataSaved.altezzaLama * 0.35, hdt_LAMA);
        p13 = Exca_Quaternion.endPoint(p9, correctPitch + 160, correctRoll, DataSaved.altezzaLama * 0.35, hdt_LAMA);
        p3 = Exca_Quaternion.endPoint(p4, correctPitch - 120, correctRoll, DataSaved.altezzaLama * 0.2, hdt_LAMA);
        p7 = Exca_Quaternion.endPoint(p6, correctPitch - 120, correctRoll, DataSaved.altezzaLama * 0.2, hdt_LAMA);
        ...
        c2 = Exca_Quaternion.endPoint(c1, correctPitch + 180, correctRoll, DataSaved.altezzaLama * 0.1, hdt_LAMA);
        ant1_a = startXYZ;
