    ...
    public static void handleCRS(String input, MyData MyData, DataSaved DataSaved, Activity activity, Dialog dialog) {
        switch (input) {
            ...
            case "MOZAMBIQUE__36_E_TO_42_E__MOZNET__UTM_ZONE_37S__3037.SP":
                MyData.push("SECONDO_S_CRS", "3037");
            ...
            case "MOZAMBIQUE__MOZNET__4952.SP":
                MyData.push("SECONDO_S_CRS", "4952");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__MOZNET__GEOCENTRIC__4358.SP":
                MyData.push("SECONDO_S_CRS", "4358");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__OFFSHORE__WGS_84__TM_36_SE__32766.SP":
                MyData.push("SECONDO_S_CRS", "32766");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__ONSHORE_EAST_OF_36_E__MOZNET__UTM_ZONE_38S__5629.SP":
                MyData.push("SECONDO_S_CRS", "5629");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__ONSHORE_EAST_OF_36_E__TETE__UTM_ZONE_37S__2737.SP":
                MyData.push("SECONDO_S_CRS", "2737");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__ONSHORE_WEST_OF_36_E__TETE__UTM_ZONE_36S__2736.SP":
                MyData.push("SECONDO_S_CRS", "2736");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
            ...
            case "MOZAMBIQUE__WEST_OF_36_E__MOZNET__UTM_ZONE_36S__3036.SP":
                MyData.push("SECONDO_S_CRS", "3036");
                DataSaved.SECONDO_S_CRS = MyData.get_String("SECONDO_S_CRS");
                activity.recreate();
                ReadProjectService.startCRS();
                dialog.dismiss();
